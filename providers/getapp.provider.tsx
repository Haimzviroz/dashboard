...
import { R_APP_DEVICES, R_MAP_DEVICES, R_DEVICES, R_MAPS, R_PROJECTS, R_GET_APP, R_SETTINGS } from "@/apis/routes";
...
const GetAppProvider: FC<any> = ({ children }: any) => {
	...
	const getSideBarActivated = () => {
		...
		if (router.pathname.startsWith(R_SETTINGS)) return SideBarOption.SETTINGS;
	}
